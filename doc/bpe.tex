...
means exacly what it says up to Erlang pids. For sending documents to
...
The nice thing about all pallete of different implementataion of workflow models is
