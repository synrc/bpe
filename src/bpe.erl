...
processAuthorized(true, _, Task, Flow,
    ...
    NewState0 = State#process{executors = executors(State, Flow)},
    NewResult0 = Res#result{state = NewState0, executed = NewExecuted},
    #hist{task = NewTask} = add_trace(NewState0, [], Flow),
    NewState = NewState0#process{stage = NewTask},
    NewResult = NewResult0#result{state = NewState},
